...
_DEMO_SEGMENTS: list[tuple[float, float, str]] = [
    (
        0.0,
        4.5,
        "Buenos días a todos, gracias por conectarse. El objetivo de hoy es definir el alcance del primer sprint.",
    ),
    (
        4.5,
        9.0,
        "Perfecto. Desde mi lado, la prioridad es cerrar la integración del módulo de pagos antes de fin de mes.",
    ),
    (
        9.0,
        13.5,
        "De acuerdo, aunque deberíamos validar primero los requisitos con el equipo de seguridad.",
    ),
    (
        13.5,
        18.0,
        "Buen punto. Agendemos esa revisión para el miércoles. ¿Quién puede coordinarla?",
    ),
    (18.0, 22.0, "Yo me encargo de coordinar la reunión con seguridad."),
    (
        22.0,
        27.0,
        "Entonces quedo a la espera de la confirmación para preparar la documentación técnica.",
    ),
